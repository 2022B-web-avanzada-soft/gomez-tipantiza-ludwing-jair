    ...
    const enviarEventoHola = () => {
        ...
        socket.emit(
            ...
            (datosEventoHola) => { // Callback o respuesta del evento
                console.log("Realizado en el servidor")
                console.log(datosEventoHola) // {mensaje: 'ok'};
                //      LAS DOS FORMAS HACEN LO MISMO, pero el callback es en casos especiales
                // esos casos especiales son con objetos
                // que en js son un poco diferentes al hablar por referencia o por valor
